...
local frames64IconOverlays = {
  "ArcReactor", "Core", "Energize", "Fire", "Frost", "Ghostbuster", "Haze", "Heat", "Kryptonite", "Rainbow", "SimpleOrange", "SimpleOrange2", "SimplePurple2", "Water", "Zap"
}
...
for _, key in ipairs(frames30IconOverlays) do
  local file = "Interface\\AddOns\\WeakAurasStopMotion\\Textures\\IconOverlays\\" .. key
  WeakAuras.StopMotion.texture_types.IconOverlays[file] = key
  WeakAuras.StopMotion.texture_data[file] = frames30Data
end
